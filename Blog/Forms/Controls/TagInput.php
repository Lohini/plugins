 ...
 */
/**
 * Lohini plugin Blog port
 * @author Lopo <lopo@lohini.net>
 * @copyright 2010 Lopo <lopo@lohini.net> (Lohini plugin Blog port)
 */
...
extends \Nette\Forms\Controls\TextInput
{
	 ...
	 * @throws \Nette\InvalidStateException
	 */
	public function renderResponse(\Nette\Application\UI\Presenter $presenter, $filter)
	{
		$data=array();
